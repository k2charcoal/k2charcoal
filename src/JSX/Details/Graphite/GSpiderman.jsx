...
import FC1 from '../../../Asset/GRAPHITE/3.jpg'
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — AVENGER SPIDERMAN (GRAPHITE SKETCH)</strong><br />
                Name: Avenger Spiderman Sketch <br />
