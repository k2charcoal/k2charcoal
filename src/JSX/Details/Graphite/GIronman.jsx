...
import FC1 from '../../../Asset/GRAPHITE/11.jpg'
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — AVENGER IRONMAN (GRAPHITE SKETCH)</strong><br />
                Name: Avenger Ironman Sketch <br />
