...
import FC1 from '../../../Asset/CHARCOAL + GRAPHITE/24.jpg'
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — RADHAJI (CHARCOAL + GRAPHITE SKETCH)</strong><br />
                Name: Radhaji Sketch <br />
