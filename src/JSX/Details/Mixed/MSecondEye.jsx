...
import FC1 from '../../../Asset/CHARCOAL + GRAPHITE/18.jpg'
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — EGYPTIAN, JAPANESE, GHOST EYE (CHARCOAL + GRAPHITE SKETCH)</strong><br />
                Name: Egyptian, Japanese, Ghost Eye Sketch <br />
