...
import FC1 from '../../../Asset/CHARCOAL/14.jpg'
import logo from '../../../Asset/logo2.jpg'

const CRadhaKrishnaEye = () => {
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — RADHA KRISHNA EYE (CHARCOAL SKETCH)</strong><br />
                Name: Radha Krishna Eye Sketch <br />
                Medium: Charcoal <br />
                Size: A4 <br />
                Price: ₹699 <br />
                Disc: 10% OFF <br />
...
export default CRadhaKrishnaEye
