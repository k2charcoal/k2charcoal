...
import FC1 from '../../../Asset/CHARCOAL/21.jpg'
import logo from '../../../Asset/logo2.jpg'

const CDarkKrishnaji = () => {
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — DARK KRISHNAJI (CHARCOAL SKETCH)</strong><br />
                Name: Dark Krishnaji Sketch <br />
                Medium: Charcoal <br />
                Size: A4 <br />
                Price: ₹699 <br />
                Disc: 10% OFF <br />
