...
import FC1 from '../../../Asset/CHARCOAL/19.jpg'
      ...
      <div className="GThorMain">
        ...
        <div className="Detail">
          ...
          <div className="ThorDetails">
            <p>
                <strong>ART DETAILS — CHHATRAPATI SAMBHAJI MAHARAJ (CHHAVA) (CHARCOAL SKETCH)</strong><br />
                Name: Chhatrapati Sambhaji Maharaj (Chhava) Sketch <br />
                Medium: Charcoal <br />
                Size: A4 <br />
                Price: ₹699 <br />
                Disc: 10% OFF <br />
